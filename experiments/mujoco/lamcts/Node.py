...
class Node:
    ...
    def __init__(
        self, parent=None, dims=0, reset_id=False, kernel_type="rbf", gamma_type="auto"
    ):
    ...
    def propose_samples_turbo(self, num_samples, path, func, method, acqf):
        proposed_X, fX = self.classifier.propose_samples_turbo(
            num_samples, path, func, method, acqf
        )
