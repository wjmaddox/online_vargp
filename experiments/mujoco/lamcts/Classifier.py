...
class Classifier:
    ...
    def propose_samples_turbo(self, num_samples, path, func, method, acqf, saas=True):
        ...
        turbo1 = Turbo1(
            ...
            n_training_steps=250,  # Number of steps of ADAM to learn the hypers
            min_cuda=2,  #  Run on the CPU for small datasets
